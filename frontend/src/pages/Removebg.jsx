...
const Removebg=()=> {
  ...
  <input onChange={(e) => setInput(e.target.files[0])} type='file' accept="image/*" className='w-full p-2 px-3 mt-2 outline-none text-sm rounded-md border border-gray-300' placeholder='Describe what you want to generate' required />
 
   <p className='text-xs text-gray-500 font-light mt-1'> Supports jpg,png and other image formats</p>
  <button className="bg-gradient-to-r from-[#14B8A6] to-[#0D9488] w-full flex justify-center items-center gap-2 text-white px-4 py-1 mt-6 border rounded-full cursor-pointer">Remove Background</button>
      </form>
